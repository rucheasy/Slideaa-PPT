# SlideAI – AI PPT Generator  

SlideAI is a full-stack web application that generates structured presentation slides from a given topic. It uses a React frontend and a backend API to dynamically create slide titles and key bullet points.
